...
const TOOLTIPS = {
  ...
  stockAdjustmentValue:
    "Physical-count corrections that adjust closing stock, valued at selling price × the admin-set cost ratio. A + means stock was found; no + means stock is missing.",
