 ...
 * netProfit()'s inputs.
 *
 * stockConsumption's values (post-launch change, 2026-07-23 — see
 * docs/01_DATA_MODEL.md §3.11): wastageValue/staffMealValue/
 * complimentaryMealValue/stockAdjustmentValue are quantity *
 * selling_price_snapshot * app_settings.estimated_cost_ratio,
 * UNCONDITIONALLY — not quantity * buying_price_snapshot, and not
